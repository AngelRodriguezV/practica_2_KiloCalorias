...
import com.angelrv.calculos.MetodoHB;
 ...
 * @author veneg
 */
public class ControlCalcularHB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        double estatura = Double.parseDouble(request.getParameter("altura"));
        ...
        request.setAttribute("metodo", "Harris Benedict");
